  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        ...
        ? removeUsersInterestedCar(context: context,docId: (deleteInterestFromCarsPage == true)? userInterestedData : userInterestedData.id,isNavBack: true,isSellerRemovingInterestedCar: false)
        ...
        ? removeUsersInterestedCar(context: context,docId: interestedDataIdInSeller.id,isNavBack: true,isSellerRemovingInterestedCar: true,removeInterestBySeller: interestedDataIdInSeller)
        : (markCarAsSold==true)
