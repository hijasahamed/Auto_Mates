...
class FuelTypeContainerWidget extends StatelessWidget {
  const FuelTypeContainerWidget({super.key, required this.screenSize});
            ...
            return BlocBuilder<BuyScreenBloc, BuyScreenState>(
              ...
              builder: (context, state) {
                return GestureDetector(
                  onTap: () {
                    buyScreenBloc.add(CarFuelFilterStateRefreshEvent(selectedFuel: fuelTypes[index].fuelType, index: index));
                  },
                  child: CircleAvatar(
