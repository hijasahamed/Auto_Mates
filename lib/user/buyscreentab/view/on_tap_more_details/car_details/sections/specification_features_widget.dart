            ...
            child: TabBarView(
              children: [
                ListView(
                  ...
                  children: [
                   TabBarViewListTile(leading: 'Price', title: data['price'],screenSize: screenSize ),
                ...
                ListView(
                  children: [
                   ...
                   TabBarViewListTile(leading: 'BootSpace', title: data['bootspace'],screenSize: screenSize,),
                   ...
                   TabBarViewListTile(leading: 'Infotainment', title: data['infotainment'],screenSize: screenSize ),
                   TabBarViewListTile(leading: 'Milage', title: data['milage'],screenSize: screenSize ),
                   TabBarViewListTile(leading: 'Power Window', title: data['powerwindow'],screenSize: screenSize ),
                   TabBarViewListTile(leading: 'Seat Capacity', title: data['seat'],screenSize: screenSize ),
