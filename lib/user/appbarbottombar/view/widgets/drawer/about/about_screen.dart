        ...
        child: Column(
          ...
          children: [
            ...
            MyTextWidget(
                  ...
                  weight: FontWeight.w300),
            MyTextWidget(
                  text: '''\nJoin Us:\nBecome part of our growing community today and explore the exciting world of cars with [App Name]. Whether you're a buyer or a seller, we're here to help you every step of the way.''',
                  color: Colors.blueGrey,
                  maxline: true,
                  size: screenSize.width / 30,
                  weight: FontWeight.w300),
