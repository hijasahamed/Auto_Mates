...
showBottomSheetForPremium({context, screenSize,sellerId,sellerData}) {
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: screenSize.height / 50,),
            PremiumPlanButton(screenSize: screenSize, subscriptionBlocInstance: subscriptionBlocInstance,sellerId: sellerId,sellerData: sellerData,),
            SizedBox(height: screenSize.height / 50,)
          ],
        ),
      );
